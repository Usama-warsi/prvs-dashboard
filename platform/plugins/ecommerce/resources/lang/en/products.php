...
return [
    'name' => 'Report',
    'description' => 'View and update your Reports settings',
    'create' => 'New Report',
    'create_product_type' => [
        'digital' => 'New Report',
    ],
    'edit' => 'Edit Report - :name',
    'form' => [
        'name' => 'Name',
        'name_placeholder' => 'Report\'s name (Maximum 120 characters)',
        'description' => 'Description',
        'description_placeholder' => 'Short description for Report (Maximum 400 characters)',
        ...
        'stock' => [
            'allow_order_when_out' => 'Allow customer checkout when this Report out of stock',
            'in_stock' => 'In stock',
            'out_stock' => 'Out stock',
            'title' => 'Stock status',
        ],
        ...
        'add_new_attributes_description' => 'Adding new attributes helps the Report to have many options, such as size or color.',
        'create_product_variations' => ':link to create Report variations!',
        'tags' => 'Tags',
        ...
        'updated_product_attributes_success' => 'Updated Report attributes successfully!',
        ...
        'barcode_existed' => 'This barcode is using by another Report. Please enter another barcode.',
        'barcode_helper' => 'Must be unique for each Report.',
    ],
    'price' => 'Price',
    'quantity' => 'Quantity',
    'type' => 'Type',
    ...
    'brand' => 'Brand',
    'cannot_delete' => 'Report could not be deleted',
    'product_deleted' => 'Report deleted',
    'product_collections' => 'Report collections',
    'products' => 'Reports',
    'menu' => 'Reports',
    'control' => [
    ...
    'price_group_title' => 'Manager Report price',
    'store_house_group_title' => 'Manager store house',
    'shipping_group_title' => 'Manager shipping',
    'overview' => 'Overview',
    'attributes' => 'Attributes',
    'product_has_variations' => 'Report has variations',
    'manage_products' => 'Manage Reports',
    'add_new_product' => 'Add a new Report',
    'start_by_adding_new_product' => 'Start by adding new Reports.',
    'edit_this_product' => 'Edit this Report',
    'delete' => 'Delete',
    'related_products' => 'Related Reports',
    'cross_selling_products' => 'Cross-selling Reports',
    'up_selling_products' => 'Up-selling Reports',
    'grouped_products' => 'Grouped Reports',
    'search_products' => 'Search Reports',
    'selected_products' => 'Selected Reports',
    ...
    'generate_variations_confirmation' => 'Are you sure you want to generate variations for this Report?',
    ...
    'product_create_validate_name_required' => 'Please enter Report\'s name',
    ...
    'category' => 'Category',
    'product_price_flash_sale_warning' => 'This Report is in flash sale <strong>:name</strong> so its price is <strong>:price</strong>.',
    'product_price_discount_warning' => 'This Report is in discount <strong>:name</strong> so its price is <strong>:price</strong>.',
    ...
    'digital_attachments' => [
        ...
        'generate_license_code_after_purchasing_product' => 'Generate license code after purchasing this Report?',
    ...
    'export' => [
        'description' => 'Export your Report data to CSV or Excel files.',
        'total_items' => 'Total Items',
        'total_products' => 'Total Reports',
        'total_variations' => 'Total Variations',
    ],
    'import' => [
        'description' => 'Import your Report data from CSV or Excel files.',
        'rules' => [
        ...
        'updated_message' => 'Updated :count Reports successfully!',
    ],
    'import_products_intro' => 'Or import Reports from CSV/Excel',
