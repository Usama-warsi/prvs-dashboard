...
return [
    ...
    'product' => [
        'name' => 'Report',
        'description' => 'View and update yourReport settings',
        'product_settings' => 'Product settings',
        'product_settings_description' => 'Configure rules for product',
        'form' => [
            'show_number_of_products' => 'Show number ofReport in the product single',
            'show_out_of_stock_products' => 'Show out of stockReport',
            ...
            'is_enabled_cross_sale_products' => 'Enable cross saleReport',
            'is_enabled_related_products' => 'Enable relatedReport',
    ...
    'product_search' => [
        ...
        'form' => [
            ...
            'search_products_by' => 'SearchReport by:',
            'enable_filter_products_by_brands' => 'Enable filterReport by brands',
            'enable_filter_products_by_tags' => 'Enable filterReport by tags',
            'enable_filter_products_by_attributes' => 'Enable filterReport by attributes',
        ],
    ],
    'digital_product' => [
        'name' => 'Digital Report',
        'description' => 'View and update digitalReport settings',
        'digital_products_settings' => 'DigitalReport',
        'digital_products_settings_description' => 'Configure rules for digitalReport',
        'form' => [
            'enable_support_digital_product' => 'Is it enabled to support digitalReport',
            'allow_guest_checkout_for_digital_products' => 'Allow guest checkout for digitalReport',
    ...
    'checkout' => [
        ...
        'form' => [
            ...
            'recently_viewed' => [
                'enable' => 'Enable customer recently viewedReport',
                'max' => 'Maximum number of customer recently viewedReport',
                'max_helper' => 'If you set 0, it will save allReport.',
            ],
    ...
    'return' => [
        ...
        'form' => [
            ...
            'allow_partial_return_description' => 'Customer can return a fewReport, do not need to return allReport in an order.',
    ...
    'store_locator' => [
        ...
        'store_locator_description' => 'All the lists of your chains, main stores, branches, etc. The locations can be used to track sales and to help us configure tax rates to charge when sellingReport.',
        'form' => [
    ...
    'flash_sale' => [
        ...
        'show_sale_count_left_description' => 'This option will show the number ofReport left in the flash sale.',
    ],
