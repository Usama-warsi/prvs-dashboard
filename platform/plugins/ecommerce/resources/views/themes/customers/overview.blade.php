    ...
    <div class="bb-customer-profile-wrapper">
        <div class="bb-customer-profile">
            ...
            <div class="bb-customer-profile-info">
                ...
                <p>{!! BaseHelper::clean(
                __(
                    'From your account dashboard you can view your <a class="text-primary" href=":order">recent orders</a>, manage your <a class="text-primary" href=":addresses">addresses</a>, and <a class="text-primary" href=":edit_account">edit your password and account details</a>.',
                    [
