...
use Botble\Payment\Services\Gateways\PayLaterPaymentService;
            ...
            switch ($request->input('payment_method')) {
                case PaymentMethodEnum::COD:
                    ...
                    case PaymentMethodEnum::PAY_LATER:
                        ...
                        $minimumOrderAmount = (float) get_payment_setting('minimum_amount', PaymentMethodEnum::PAY_LATER, 0);
                        ...
                        $data['charge_id'] = $this->app->make(PayLaterPaymentService::class)->execute($paymentData);
