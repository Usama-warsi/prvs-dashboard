...
return [
    ...
    'templates' => array_filter([
        ...
        'report_send' => [
            'title' => 'plugins/ecommerce::email.report_send_title',
            'description' => 'plugins/ecommerce::email.report_send_description',
            'subject' => 'plugins/ecommerce::email.report_send_subject',
            'can_off' => true,
            'enabled' => false,
            'variables' => [
                'customer_name' => 'plugins/ecommerce::ecommerce.customer_name',
                'customer_phone' => 'plugins/ecommerce::ecommerce.customer_phone',
                'customer_ssn' => 'plugins/ecommerce::ecommerce.customer_address',
            ],
        ],
        'order_confirm' => [
