        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
            <div class="detail-info">
                ...
                <form class="add-to-cart-form" method="POST" action="{{ route('public.cart.add-to-cart') }}">
                    ...
                    @if(BaseHelper::clean($product->credit_score) == 1)
                    <input type="hidden" name="credit_report" value="true">@endif
                    @if(BaseHelper::clean($product->background_check) == 1)
                    <input type="hidden" name="background_check" value="true">@endif
                        ...
                        <div class="product-extra-link2 @if (EcommerceHelper::isQuickBuyButtonEnabled()) has-buy-now-button @endif">
                            @if (EcommerceHelper::isCartEnabled())
                                ...
                                @if (EcommerceHelper::isQuickBuyButtonEnabled())
                                    <button class="button button-buy-now ms-2 @if ($product->isOutOfStock()) btn-disabled @endif" type="submit" name="checkout" @if ($product->isOutOfStock()) disabled @endif>{{ __('Order Report') }}</button>
                                @endif
                            @endif
